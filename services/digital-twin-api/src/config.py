...
class ApiConfig:
    ...
    alerting_service_url: str = os.getenv("ALERTING_SERVICE_URL", "http://alerting-service:8000")
    data_aggregator_url: str = os.getenv("DATA_AGGREGATOR_URL", "http://data-aggregator:8000")
